...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Swims PRE-2"); //Setăm ca titlu in partea de sus a aplicatiei numele aplicatiei ("Swims"), la care adaugam versiunea; cu necesitate de nonNull ca altfel imi apar warninguri
    ...
    public void toGenerateStudentsActivity (View view) {
        Intent generateIntent = new Intent(this, StudentsGen.class);
